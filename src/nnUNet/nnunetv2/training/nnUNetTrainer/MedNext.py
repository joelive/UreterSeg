...
from .create_mednext_v1 import create_mednextv1_smaller
from .nnUNetTrainer import nnUNetTrainer
class MedNext(nnUNetTrainer):
    ...
    def build_network_architecture(plans_manager: PlansManager,
        ...
        """
        print(len(dataset_json["labels"].keys()))
        return create_mednextv1_smaller(num_input_channels, len(dataset_json["labels"].keys()),ds=enable_deep_supervision)
