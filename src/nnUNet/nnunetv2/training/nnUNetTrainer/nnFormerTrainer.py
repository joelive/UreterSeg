...
from .nnFormer_net import nnFormer
...
class  nnFormerTrainer(nnUNetTrainer):
    ...
    def build_network_architecture(plans_manager: PlansManager,
        ...
        """
        #print("plans_manager")
        #print(plans_manager["configurations"])
        print("ConfigurationManager")
        print(configuration_manager)
        #print(ConfigurationManager.configuration['patch_size'])
        crop_size=configuration_manager.configuration['patch_size'] #[205,205,205]    #
        conv_op=nn.Conv3d
        
        embedding_dim=96
        depths=[2, 2, 2, 2]
        num_heads=[6, 12, 24, 48] #[2, 3, 6, 6] #[3, 6, 12, 24]
        embedding_patch_size=[4,4,4]
        window_size=[4,4,8,4]
        return nnFormer(crop_size=crop_size,
    ...
    def set_deep_supervision_enabled(self, enabled: bool):
        ...
        if self.is_ddp:
            ...
            self.network._deep_supervision=enabled
